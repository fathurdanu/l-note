  ...
  return (
    <div className="mx-auto">
      ...
      <div className='w-full pb-10 bg-firstColor'>
        <div className="text-center font-light text-lightColor text-8xl py-20 px-10">Categories</div>
        <div className="mx-auto px-10">
          <div className="grid grid-cols-2 gap-10 mb-10">
            <button className="relative hover:opacity-100 opacity-90" onClick={() => searchHandling("school")}>
              <img className="object-cover w-full h-[500px]" alt="laptops for schoolwork" src="https://ak.picdn.net/shutterstock/videos/1017180085/thumb/1.jpg" />
            ...
            <button className="relative hover:opacity-100 opacity-90" onClick={() => searchHandling("business")}>
              <img className="object-cover w-full h-[500px]" alt="laptops for business" src="https://img.freepik.com/free-photo/happy-casual-beautiful-woman-working-laptop-talking-with-somebody-office_566707-1241.jpg" />
          ...
          <div className="grid grid-cols-2 gap-10">
            <button className="relative hover:opacity-100 opacity-90" onClick={() => searchHandling("artist")}>
              <img className="object-cover w-full h-[500px]" alt="laptops for artists" src="https://techpulse.be/wp-content/uploads/2022/02/thinkbook.png" />
            ...
            <button className="relative hover:opacity-100 opacity-90" onClick={() => searchHandling("gaming")}>
              <img className="object-cover w-full h-[500px]" alt="laptops for gamers" src="https://pinusi.com/wp-content/uploads/2021/08/Ilustrasi-Orang-Bermain-Game.jpg" />
