...
const OrderDetailsPage = () => {
  ...
  useEffect(() => {
    if (isPaid) {
      dispatch(updatePayment(id)).then(() => dispatch(getOrder(id)))
    }
  }, [isPaid])
      ...
      <div className="container mx-auto">
        ...
        {action === "GET_ORDER" && status === "data" && data !== "Loading" ? (
          <div className="w-full text-lightColor">
            <h1 className="text-5xl text-center font-light py-3">
              Order Details
            </h1>
            <div className="flex">
                    ...
                    return (
                      <tr>
                        ...
                        <td className="hidden text-right md:table-cell pb-3">
                          <span className="text-sm lg:text-base font-medium">
                            {intToRupiah(product.price)}
                          </span>
                        </td>
                        <td className="text-right pb-3">
                          <span className="text-sm lg:text-base font-bold text-lightColor">
                            {intToRupiah(product.price * product.LineItem.qty)}
                          </span>
                        </td>
                      </tr>
                    );
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <Link to="#">
                              {data.status === "unpaid" ? (
                                <p className="mb-4 md:ml-4 text-lightColor font-bold">
